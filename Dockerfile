...
#linuxbrew
RUN git clone https://github.com/Linuxbrew/brew.git /home/gpds/.linuxbrew
ENV PATH=/home/gpds/anaconda3/bin:/home/gpds/.linuxbrew/bin:/home/gpds/.linuxbrew/sbin:$PATH
RUN brew doctor
RUN brew update
...
RUN /home/gpds/anaconda3/bin/pip install keras==2.1.5
RUN mkdir ~/.keras
